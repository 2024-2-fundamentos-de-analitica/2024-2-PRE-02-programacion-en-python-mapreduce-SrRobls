...
def line_preprocessing(sequence):
    """Line Preprocessing"""
    sequence = [
            # Eliminar signos de puntuación y convertir a minúsculas y con strip() eliminar espacios en blanco
...
def shuffle_and_sort(sequence):
    """Shuffle and Sort"""
    # Ordenar por clave que es la primera posición de la tupla, osea la palabra
...
def run_job(input_directory, output_directory):
    ...
    sequence = reducer(shuffle_and_sort(mapper(line_preprocessing(sequence))))
